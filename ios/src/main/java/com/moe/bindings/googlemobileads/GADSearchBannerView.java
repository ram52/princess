...
@ObjCClassBinding
public class GADSearchBannerView extends GADBannerView {
	static {
		NatJ.register();
	}

	@Generated
	protected GADSearchBannerView(Pointer peer) {
		super(peer);
	}
	...
	@Owned
	@Selector("alloc")
	public static native GADSearchBannerView alloc();
	...
	@Generated
	@Selector("init")
	public native GADSearchBannerView init();

	@Generated
	@Selector("initWithAdSize:")
	public native GADSearchBannerView initWithAdSize(@ByValue GADAdSize adSize);

	@Generated
	@Selector("initWithAdSize:origin:")
	public native GADSearchBannerView initWithAdSizeOrigin(
			@ByValue GADAdSize adSize, @ByValue CGPoint origin);

	@Generated
	@Selector("initWithCoder:")
	public native GADSearchBannerView initWithCoder(NSCoder aDecoder);
