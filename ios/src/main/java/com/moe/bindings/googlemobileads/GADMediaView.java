...
@ObjCClassBinding
public class GADMediaView extends UIView {
	static {
		NatJ.register();
	}

	@Generated
	protected GADMediaView(Pointer peer) {
		super(peer);
	}
	...
	@Owned
	@Selector("alloc")
	public static native GADMediaView alloc();
	...
	@Generated
	@Selector("init")
	public native GADMediaView init();

	@Generated
	@Selector("initWithCoder:")
	public native GADMediaView initWithCoder(NSCoder aDecoder);

	@Generated
	@Selector("initWithFrame:")
	public native GADMediaView initWithFrame(@ByValue CGRect frame);
