...
@ObjCClassBinding
public class GADNativeAppInstallAd extends GADNativeAd {
	static {
		NatJ.register();
	}

	@Generated
	protected GADNativeAppInstallAd(Pointer peer) {
		super(peer);
	}
	...
	@Owned
	@Selector("alloc")
	public static native GADNativeAppInstallAd alloc();
	...
	@Generated
	@Selector("init")
	public native GADNativeAppInstallAd init();
