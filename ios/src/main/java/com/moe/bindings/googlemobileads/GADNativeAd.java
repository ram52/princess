...
import com.moe.bindings.googlemobileads.protocol.GADNativeAdDelegate;
...
@ObjCClassBinding
public class GADNativeAd extends NSObject {
	static {
		NatJ.register();
	}

	@Generated
	protected GADNativeAd(Pointer peer) {
		super(peer);
	}
	...
	@Owned
	@Selector("alloc")
	public static native GADNativeAd alloc();
	...
	@Selector("delegate")
	@MappedReturn(ObjCObjectMapper.class)
	public native GADNativeAdDelegate delegate();
	...
	public native NSDictionary<?, ?> extraAssets();
