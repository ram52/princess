...
@ObjCClassBinding
public class GADRewardBasedVideoAd extends NSObject {
	static {
		NatJ.register();
	}

	@Generated
	protected GADRewardBasedVideoAd(Pointer peer) {
		super(peer);
	}
	...
	@Owned
	@Selector("alloc")
	public static native GADRewardBasedVideoAd alloc();
	...
	@Selector("delegate")
	@MappedReturn(ObjCObjectMapper.class)
	public native GADRewardBasedVideoAdDelegate delegate();
	...
	public native void loadRequestWithAdUnitID(GADRequest request,
			String adUnitID);
